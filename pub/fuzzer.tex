...
Our results prove that languages with weak type systems are significantly
likelier than languages that enforce strong typing to let fuzzed programs
compile and run to produce erroneous results.
This also shows that comparative language fuzz testing is a
