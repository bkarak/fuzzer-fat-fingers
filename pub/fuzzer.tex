...
and \ref{tbl:contingency-test-results-1}. 
...
four bands, one for each test, in the order {\em IdSub}, {\em
  IntPert}, {\em RandCharSub}, {\em RandTokenSub}, {\em SimSub}. In
each band, the tests are, in order, {\em compilation},
{\em execution (run)}, {\em output validity}. Among the results that stand
out:
\begin{itemize}
